...
- When is a component "mounted" to the DOM?
  - a component is mounted to the DOM when its rendered for the first time
...
- When should you use an Effect and when should you not use an Effect?
  ...
  - when you interact with a part of the browser that is not part of React
  - asynchronous functions within the render
- When do Effects run?
...
- Why would you want to clean up from an Effect?
  ...
  - any time there is a resource allocation
...
- When does the cleanup function run?
  ...
  - if the Effect is called again (when dependencies change)
