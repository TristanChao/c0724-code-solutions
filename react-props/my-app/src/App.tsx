...
const imgDescr = `Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam
...
export default function App() {
  return (
    <>
      ...
      <ImageContainer sourceUrl={imgSrc} />
      <ImageCaption textContent={imgCaption} />
      <ImageDescription textContent={imgDescr} />
      <ButtonContainer textContent={buttonText} />
    </>
  );
}
